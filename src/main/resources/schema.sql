...
CREATE OR REPLACE FUNCTION create_admin(_name TEXT, _email TEXT, _password TEXT)
  RETURNS RECORD AS '
DECLARE
  rec RECORD;
BEGIN
...
CREATE TABLE IF NOT EXISTS words (
  ...
  slang       CITEXT  NOT NULL REFERENCES slangs (slang) ON DELETE CASCADE ON UPDATE CASCADE,
